...
class SevenNetCalculator(Calculator):
    ...
    def __init__(
        ...
        enable_pairaware: Optional[bool] = False,
        ...
        **kwargs,
        ...
        enable_pairaware: bool, default=False
            if True, use pair-aware geometry reuse during inference.
        ...
        enable_pairaware = (
            os.getenv('SEVENNET_ENABLE_PAIRAWARE') == '1' or enable_pairaware
        )
